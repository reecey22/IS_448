...
<body>
<div class="roof">
<h1 class = "roof_text"> Roofview <img src="https://swe.umbc.edu/~sreece1/is448/Group_Project/deliverable6/map.png"
alt="Map" class="img.h1"></h1>
<!--Insert icon-->
<i class="fa fa-user" style="color:white; float:right; margin-top: 10px;"></i>
<input type = "button" class="goBack4" style="margin-top:2px;"
onclick="location.href='https://swe.umbc.edu/~sreece1/is448/Group_Project/deliverable6/Roofview_Screen4_FilterLocation.html'"
value="Back to Roofview Sort">
</div>
<!--Initiate form-->
<?php
#connect to database
...
$sort = isset($_POST['sort_selection'])?$_POST['sort_selection']:"None";
?>
<br>
<h1 class="bold">Locations in Maryland: <span class="selected">
<?php
#display location
if($location == 'ec'){
...
?></span>
<div class = "sort_php">
Sort by: </span> <span class="selected">
<?php
#display Sort
if($sort == 'cost'){
	echo "Cost";
	...
	echo "Ratings";
}elseif($sort == 'transit_access'){
	echo "Transit Access";
}elseif($sort == 'student_discount'){
...
$ellicott_city = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Ellicott City'";
$inner_harbor = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Inner Harbor'";
$arbutus = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Arbutus'";
$annapolis = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Annapolis'";
$catonsville = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Catonsville'";
...
#sort locations based on sort box
if($sort == 'cost'){
	if($location == 'ec'){
		$ellicott_city = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Ellicott City' order by cost";
		$ec_result = mysqli_query($db, $ellicott_city);
		...
		$inner_harbor = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Inner Harbor' order by cost";
		$ih_result = mysqli_query($db, $inner_harbor);
		...
		$annapolis = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Annapolis' order by cost";
		$anps_result = mysqli_query($db, $annapolis);
		...
		$catonsville = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Catonsville' order by cost";
		$caton_result = mysqli_query($db, $catonsville);
	...
	if($location == 'ec'){
		$ellicott_city = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Ellicott City' order by ratings";
		$ec_result = mysqli_query($db, $ellicott_city);
		display_location();
	}elseif($location == 'ih'){
		$inner_harbor = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Inner Harbor' order by ratings";
		$ih_result = mysqli_query($db, $inner_harbor);
		...
		$arbutus = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Arbutus' order by ratings";
		$arb_result = mysqli_query($db, $arbutus);
		...
		$annapolis = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Annapolis' order by ratings";
		$anps_result = mysqli_query($db, $annapolis);
		$anps_photos[0] = "Locations/Sandy_Point_State_Park.jpg";
	...
	if($location == 'arb'){
		$arbutus = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Arbutus' order by transit_access";
		$arb_result = mysqli_query($db, $arbutus);
		...
		$catonsville = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Catonsville' order by transit_access";
		$caton_result = mysqli_query($db, $catonsville);
	...
	if($location == 'ec'){
		$ellicott_city = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Ellicott City' order by student_discount";
		$ec_result = mysqli_query($db, $ellicott_city);
		$ec_photos[1] = "Locations/Bo_Railroad_Museum.jpg";
		$ec_photos[2] = "Locations/trolly_stop.png";
		display_location();
		...
		$inner_harbor = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Inner Harbor' order by student_discount";
		$ih_result = mysqli_query($db, $inner_harbor);
		$ih_photos[0] = "Locations/Historic_Ships_in_Baltimore.jpg";
		$ih_photos[1] = "Locations/Fort_McHenry.jpg";
		display_location();
		...
		$arbutus = "select location_id, location, ratings, cost, transit_access, student_discount
from places where location_id = 'Arbutus' order by student_discount";
		$arb_result = mysqli_query($db, $arbutus);
		$arb_photos[0] = "Locations/Wonderfly_Arena.jpg";
		$arb_photos[1] = "Locations/Sorrento.png";
		$arb_photos[2] = "Locations/OCA_Mocha.png";
...
}elseif($sort == 'None'){display_location();}
